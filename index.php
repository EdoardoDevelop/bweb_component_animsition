...
class BcanimsitionSettings {
    ...
    public function load_animsition(){
        wp_enqueue_script( 'pagetransition-dist-scripts', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ) . 'animsition/assets/animsition.js', array( 'jquery' ),'', false );
        wp_enqueue_style( 'pagetransition-style', plugin_dir_url( DIR_COMPONENT .  '/bweb_component_functions/' ).'animsition/assets/animsition.css');
